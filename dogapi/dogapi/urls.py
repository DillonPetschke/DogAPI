...
#    re_path(r'^dogs/$', views.DogViewSet.as_view({'post'}, name="create")),
#    re_path(r'/api/^breed/', views.BreedViewSet.create, name="create"),
    #re_path(r'^dogs/$', DogList.as_view(), name="create"),
    #re_path(r'api/^breed/$', BreedList.as_view(), name="create"),


#    re_path(r'^dogs', csrf_exempt(controllers.DogDetails.as_view())),
#    re_path(r'^dogs/$', views.DogViewSet.as_view({'get'}, name="list")),
#    re_path(r'^dogs/(?P<pk>[0-9]+)/$', DogDetails.as_view(), name="details"),
#    re_path(r'api/^breed/$', BreedList.as_view(), name="bcreate"),
#    re_path(r'^breed/(?P<pk>[0-9]+)/$', BreedDetails.as_view(), name="bdetails"),
]
